...
- **论文 ID**：`tabula-sapiens-2022`
- **作者**：Tabula Sapiens Consortium et al.
- **年份 / 来源**：2022，Science
- **DOI**：10.1126/science.abl4896
- **官方论文页**：https://doi.org/10.1126/science.abl4896
- **与数据的关系**：data generation and atlas release
- **PDF 保存状态**：未上传；尚未逐篇确认出版商 PDF 的再分发许可

## 关联数据

- `DS011`：Tabula Sapiens
